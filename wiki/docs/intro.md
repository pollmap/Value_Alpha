...
가치투자, 모멘텀, 스윙 트레이딩, 퀀트, 이벤트 드리븐, 시장 미시구조 등 6대 매매 전략을 전문가 수준으로 다룹니다. 포지션 사이징과 포트폴리오 구성 등 리스크 관리도 함께 학습합니다.

### 인터랙티브 도구

- [금융 성향 테스트 (Finance MBTI)](./finance-mbti) — 20문항으로 나에게 맞는 금융 섹터·직무를 찾아보세요
...
- [실시간 시장 현황](./tools/market-overview) — 주요 지수, 환율, 금리 실시간 확인
- [경제 캘린더](./tools/economic-calendar) — FOMC, 금통위, CPI 등 주요 경제 이벤트 일정
- [포트폴리오 시뮬레이터](./tools/portfolio-simulator) — 자산 배분 백테스트
- [기업 비교 도구](./tools/company-comparison) — 두 기업의 재무 지표 비교
- [한국 금융사 타임라인](./tools/finance-timeline) — 1997년 IMF부터 현재까지 주요 이벤트
- [학습 진도 추적](./tools/progress-tracker) — 학습 완료 현황 관리
- [분석 템플릿 다운로드](./tools/templates) — DCF, 3-Statement 등 Excel 템플릿
...
- [리스크 관리](./risk-management/overview)와 함께 학습
...
본 위키의 콘텐츠는 공개된 금융 자료, 금융감독원·한국은행·금융투자협회 등 공공기관 발간물, 각 금융사 공시 자료, 학술 문헌 등을 참고하여 작성되었습니다. 특정 기업의 재무 데이터는 DART 전자공시시스템, 각사 IR 자료 등 공신력 있는 출처를 기반으로 합니다. 본 위키는 학습 및 정보 제공 목적이며, 투자 권유를 목적으로 하지 않습니다.
