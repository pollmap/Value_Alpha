...
| 패턴 | 주가 | 거래량 | 해석 |
|------|------|--------|------|
| 상승 확인 | 상승 | 증가 | 건전한 상승 추세입니다 |
| 상승 의심 | 상승 | 감소 | 상승 추세 약화 가능성이 있습니다 |
| 하락 확인 | 하락 | 증가 | 강한 매도 압력이 존재합니다 |
| 하락 둔화 | 하락 | 감소 | 매도 소진으로 반등 가능성이 있습니다 |
| 바닥 신호 | 횡보 | 극소량 | 매도 세력 소진, 반등 임박 가능합니다 |
| 천정 신호 | 횡보 | 급증 | 대량 물량 교체, 고점 가능성이 있습니다 |
...
| 구분 | KOSPI | KOSDAQ |
|------|-------|--------|
| 성격 | 유가증권시장 (대형주 중심) | 코스닥시장 (중소형/벤처 중심) |
| 상장 기업 수 | 약 800~900개 | 약 1,600~1,700개 |
| 시가총액 | 약 2,000조원 이상 | 약 400조원 이상 |
| 대표 지수 | KOSPI, KOSPI200 | 코스닥지수, 코스닥150 |
| 외국인 비중 | 약 30~35% | 약 8~12% |
| 가격제한폭 | ±30% | ±30% |
...
| 단계 | 발동 조건 | 효과 |
|------|-----------|------|
| 1단계 | KOSPI가 전일 대비 8% 이상 하락하고 1분간 지속 | 20분간 매매 중단 |
| 2단계 | 1단계 발동 후 KOSPI가 추가 하락하여 15% 이상 하락 | 20분간 매매 중단 |
| 3단계 | 2단계 발동 후 KOSPI가 추가 하락하여 20% 이상 하락 | 당일 매매 종료 |
...
| 항목 | 긍정 신호 | 부정 신호 | 가중치 |
|------|-----------|-----------|--------|
| 외국인 수급 | 5일 이상 연속 순매수 | 5일 이상 연속 순매도 | 30% |
| 기관 수급 | 투신/연기금 순매수 | 투신/연기금 순매도 | 25% |
| 거래량 추세 | 상승 시 거래량 증가 | 상승 시 거래량 감소 | 20% |
| 프로그램 수급 | 비차익 매수 유입 | 차익 매도 잔고 증가 | 15% |
| 공매도 추이 | 공매도 잔고 감소 | 공매도 잔고 급증 | 10% |
