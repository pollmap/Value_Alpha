...
| 기호 | 의미 | 설명 |
|------|------|------|
| **E** | Equity (자기자본) | 시가총액 사용 |
| **D** | Debt (부채) | 이자부부채 (총부채 아님) |
| **V** | E + D | 기업의 총 자본 |
| **Re** | Cost of Equity | 자기자본비용 (CAPM으로 산출) |
| **Rd** | Cost of Debt | 부채비용 (이자율) |
| **T** | Tax Rate | 법인세율 |
...
| 요소 | 의미 | 한국 기준 예시 |
|------|------|---------------|
| **Rf** | 무위험이자율 | 국고채 10년물 (3.5%) |
| **β** | 베타 (시장 대비 변동성) | 1.0 = 시장과 동일 |
| **Rm - Rf** | 시장위험프리미엄 (ERP) | 5-7% |
...
| E/V | 88.9% | |
| D/V | 11.1% | |
| 무위험이자율 (Rf) | 3.5% | 국고채 10년 |
| 베타 (β) | 1.1 | 조정 베타 |
| 시장위험프리미엄 | 6.0% | |
| **자기자본비용 (Re)** | **10.1%** | 3.5% + 1.1×6% |
| 세전 부채비용 (Rd) | 4.5% | |
| 법인세율 (T) | 22% | |
| **세후 부채비용** | **3.51%** | 4.5% × (1-22%) |
| **WACC** | **9.37%** | 88.9%×10.1% + 11.1%×3.51% |

## 산업별 WACC 범위 (참고)

| 산업 | 일반적 WACC 범위 | 특징 |
|------|------------------|------|
| 유틸리티 | 5-7% | 안정적 현금흐름, 낮은 베타 |
| 금융 | 6-8% | 레버리지 효과 |
| 소비재 | 7-9% | 경기 민감도 |
| 산업재 | 8-10% | 자본 집약적 |
| 기술 | 9-12% | 높은 성장성, 높은 변동성 |
| 바이오 | 12-15%+ | 높은 불확실성 |
