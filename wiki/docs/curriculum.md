...
title: 종합 학습 커리큘럼
sidebar_label: 커리큘럼
description: 투자분석, 거시경제, 금융산업, 취업까지 - 금융 위키 전체 학습 로드맵
keywords: [커리큘럼, 학습경로, 금융교육, 투자교육, 4-Layer]
---

# 종합 학습 커리큘럼

이 커리큘럼은 금융 위키에서 제공하는 모든 학습 콘텐츠를 목적별로 정리한 안내서입니다. 투자분석 역량을 체계적으로 쌓고 싶은 분, 금융권 취업을 준비하는 분, 거시경제와 금융 산업을 깊이 이해하고 싶은 분 모두를 위한 학습 경로를 제시합니다.
