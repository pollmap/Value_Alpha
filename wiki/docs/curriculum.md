...
title: 종합 학습 커리큘럼
sidebar_label: 커리큘럼
description: 투자분석, 거시경제, 금융산업, 취업까지 - CUFA wiki 전체 학습 로드맵
keywords: [커리큘럼, 학습경로, 금융교육, 투자교육, 4-Layer]
---

# 종합 학습 커리큘럼

이 커리큘럼은 CUFA wiki에서 제공하는 모든 학습 콘텐츠를 목적별로 정리한 안내서입니다. 투자분석 역량을 체계적으로 쌓고 싶은 분, 금융권 취업을 준비하는 분, 거시경제와 금융 산업을 깊이 이해하고 싶은 분 모두를 위한 학습 경로를 제시합니다.
...
- **은행** — 예대마진, BIS비율, NIM, 대출 심사 → [바로가기](./banking-industry)
- **증권** — 브로커리지, IB, 자기매매, WM → [바로가기](./securities-industry)
- **보험** — 언더라이팅, IFRS17, 보험계리 → [바로가기](./insurance-industry)
- **여신금융** — 카드수수료, 리스, 할부금융 → [바로가기](./card-capital-industry)
- **자산운용** — AUM, 펀드 구조, 운용 전략 → [바로가기](./asset-management-industry)

**금융권 기업 총람** — 170개 이상의 한국 금융 기업 카테고리별 정리

- [개요](./companies) · [은행](./companies/banks) · [증권사](./companies/securities) · [보험사](./companies/insurance)
...
- **취업 종합 가이드** — 금융권 취업 전체 개요 → [바로가기](./career)
- **직무 종류 및 특성** — 15개 섹터, 50개 이상 직무 요약표 + 상세 분석 → [바로가기](./career/job-categories)
- **합격 요건 분석** — 섹터별 학력·자격증·어학·인턴 요건 비교표 → [바로가기](./career/requirements)
- **대회 & 포트폴리오** — 42개+ 금융권 공모전 총정리, 직무별 TOP 3 추천 → [바로가기](./career/competitions)
...
1. [금융 성향 테스트](./finance-mbti) → 2. [직무 종류](./career/job-categories) → 3. [합격 요건](./career/requirements) → 4. [자격증 가이드](./certifications) → 5. [기업 총람](./companies)
